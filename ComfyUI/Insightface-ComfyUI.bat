...
if not exist git (
    ...
    python_embeded\python.exe -m pip uninstall -y opencv-contrib-python opencv-python-headless onnxruntime-gpu onnxruntime rembg
if exist "python_embeded\python310.dll" (
  ...
  python_embeded\python.exe -m pip install onnxruntime==1.17.0
